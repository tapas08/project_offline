jQuery(document).ready(function() {
	...
	jQuery('.wp-full-overlay-sidebar-content').prepend('<a style="width: 80%; margin: 5px auto 5px auto; display: block; text-align: center; color: #fe6e41; font-weight: bold;" href="http://www.sampression.com/?add-to-cart=447" class="button" target="_blank">{pro}</a>'.replace('{pro}',objectL10n.pro));
