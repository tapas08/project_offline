/*!
 * Kopa script js (http://kopatheme.com)
...
function kopa_save_sidebar_setting() {
    ...
    jQuery.ajax({
        ...
        dataType: 'html',
        data: {
            action: "kopa_save_sidebar_setting",
 ...
 * Load layout setting
 ===============================================================*/
function kopa_load_layout_setting(obj) {
 ...
 * Save layout
 ===============================================================*/
function kopa_save_layout_setting(obj) {
    var kopa_setting = [];
...
function kopa_save_general_setting(obj) {
