<div id="kopa-admin-wrapper" class=" kopa-sidebar-manager clearfix">    
    ...
    <div class="kopa-content ">
        <div class="kopa-page-header clearfix">
            <div class="pull-left">
                <h4><?php echo KopaIcon::getIcon('cog'); ?>Sidebar Manager</h4>
            </div>
                ...
                <div class="kopa-add-sidebar-box">
                    <div class="kopa-sidebar-box kopa-element-box">
                        ...
                        <div class="clearfix mt5">
                            ...
                            <span title="Add" rel="tooltip" class="btn btn-primary left" data-original-title="Add" onclick="kopa_add_sidebar_clicked(jQuery(this))"><?php echo KopaIcon::getIcon('plus-square'); ?>Add sidebar</span>
                        </div>
