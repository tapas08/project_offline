...
/*-----------------------------------------------------------------------------------*/
	...
	add_image_size( 'madar-slide', 860, 410, true);
	...
	add_image_size( 'madar-featured', 878, 300, true);
	...
	set_post_thumbnail_size( 878, 300 ); ## featured
	// custom menu support
...
add_action ( 'wp_before_admin_bar_render', 'madar_add_help_button' );
}
      function madar_add_help_button() {
         if ( current_user_can( 'edit_theme_options' ) ) {
           global $wp_admin_bar;
           $wp_admin_bar->add_menu( array(
             'parent' => 'top-secondary', // Off on the right side
             'id' => 'madar-lite-retina' ,
             'title' =>  __( 'Help' , 'madar-lite' ),
             'href' => admin_url( 'themes.php?page=madar-lite-welcome' ),
             'meta'   => array(
                'title'  => __( 'Need help with Madar Lite? Click here!', 'madar-lite' ),
              ),
           ));
         }
      }
...
function madarlite_scripts() {
	...
	wp_enqueue_script( 'search', get_template_directory_uri() . '/js/search.js', false, '', true );	
	...
	wp_localize_script( 'madarlite-jquery-navigation', 'madarlite_menu_title', esc_html__( '', 'madar-lite' ) );
