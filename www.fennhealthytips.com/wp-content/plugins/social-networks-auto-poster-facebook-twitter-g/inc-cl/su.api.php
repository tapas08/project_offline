...
if (!class_exists('nxsAPI_SU')){class nxsAPI_SU{ var $ck = array(); var $ckey=''; var $clid='';  var $debug = false; var $proxy = array();
    ...
    function connect($u,$p){ $badOut = 'Error: '; 
      ...
      $response = nxs_remote_get('http://www.stumbleupon.com', array('headers' => $hdrsArr)); $p = substr($p, 0, 16); if (is_nxs_error($response)) return 'Connection ERROR: '.print_r($response, true);
