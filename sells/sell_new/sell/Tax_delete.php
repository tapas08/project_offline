...
if (Input::exists() && Input::get('delete') != null ){
	$delete = $db->query("DELETE FROM tax_masters WHERE `vat_catogary` = ?",array( Input::get('vat_catogary')));
		if (!$delete->error()){
...
<div class="container-fluid">
		...
		<div class="header2" >
			...
			<input type="submit" name="delete" value="F9 Delete" class="btn btn-primary">
