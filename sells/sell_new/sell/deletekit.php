...
if (Input::exists()){
		...
		$delete = $db->query("DELETE FROM kit_details WHERE `kit_name` = ?", array(Input::get('kit_name')));
		if (!$delete->error()){
			echo "Kit entry deleted!";
		}else{
    ...
    <!--<div id="container">
	   ...
	   <div id="header2">
		...
		<div class="col-md-8" style="padding-left:150px;padding-top:20px;">
						...
						<a href="kit1.php"><input type="reset" form="invoiceForm" id="reset" name="reset" class="btn btn-primary" value="Cancel"></a>
						<input type="submit" id="pendingDM" name="pendingDM" form="deleteForm" class="btn btn-primary" 
						value="F8 Delete">	
