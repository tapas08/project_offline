...
<head>
        ...
        <meta charset="utf-8" />
        <title>MediSoft Admin : Dashboard</title>
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper"> 
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class=""> 
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a class="" href="purchaseInvoice.php">Purchase Invoice</a>
                                </li>
                                <li>
                                    <a class="" href="javascript:;">New Supplier</a>
                                </li>
                                <li>
                                    <a class="" href="javascript:;">New Customer</a>
                                </li>
                                <li>
                                    <a class="" href="sells/sell/sells.php">Sale</a>
                                </li>
                                <li>
                                    <a class="" href="sells/sell/search_bill.php">Sale Return</a>
                                </li>
                                <li>
                                    <a class="" href="purchaseReturn.php">Purchase Return</a>
                                </li>
                                <li>
                                    <a class="" href="purchase.php">New Product</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
