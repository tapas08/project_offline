<form action="" id="stockist_wise_company">
	<div class="form-group col-xs-8">
		...
		<div class="col-xs-8">
			<input type="text" name="company_name" id="company_name" list="company_list" class="form-control" oninput="getList('company_name', 'company_list');">
	...
	<div class="form-group col-xs-8">
		...
		<div class="col-xs-8">
			<input type="text" name="stockist_name" id="stockist_name" class="form-control">
		</div>
		<div class="col-xs-2">
	...
	<div class="col-xs-8">
		...
		<input type="button" name="save" id="save" value="Save" class="btn btn-primary" onclick="saveEntry('company_name', 'stockist_name');">
